...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file= r"F:\Codes\Face_Recognition_for_Crime_Detection\img\back.png")
...
logo = tk.PhotoImage(file = r"F:\Codes\Face_Recognition_for_Crime_Detection\img\logo2.png")
